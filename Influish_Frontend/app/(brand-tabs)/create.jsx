...
export default function CreateCampaign() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const finalImage = hostedImageUrl || 'https://images.unsplash.com/photo-1610030469983-98e550d6193c?auto=format&fit=crop&w=800&q=80';
            ...
            <>
                ...
                <View style={styles.typeRow}>
                  ...
                  <TouchableOpacity style={[styles.typeCard, campaignType === 'barter' && styles.typeCardActiveBarter]} onPress={() => setCampaignType('barter')}>
                    <View style={[styles.typeIcon, campaignType === 'barter' && styles.typeIconActiveBarter]}>
                      <MaterialCommunityIcons name="swap-horizontal" size={28} color={campaignType === 'barter' ? THEME.white : THEME.secondary} />
                    </View>
              ...
              <View style={styles.inputGroup}>
                ...
                <View style={{ flexDirection: 'row', gap: 10, marginBottom: 10 }}>
                  <TouchableOpacity 
                    style={{ flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: 'rgba(168, 85, 247, 0.16)', borderColor: '#A855F7', borderWidth: 1, borderRadius: 14, paddingVertical: 12 }}
                    onPress={handlePickGalleryImage}
                  >
                    <MaterialCommunityIcons name="image-multiple-outline" size={20} color="#6D28FF" />
                    <Text style={{ color: '#6D28FF', fontWeight: '700', fontSize: 13 }}>Choose Gallery</Text>
                  </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  typeCardActive: { borderColor: THEME.primary, backgroundColor: 'rgba(168, 85, 247, 0.16)' },
  typeCardActiveBarter: { borderColor: THEME.secondary, backgroundColor: '#FFF0F5' },
  ...
  typeIconActiveBarter: { backgroundColor: THEME.secondary, borderColor: THEME.secondary },
  typeLabel: { fontSize: 16, fontWeight: '700', color: THEME.text, marginBottom: 4 },
  typeLabelActive: { color: THEME.primary },
  typeLabelActiveBarter: { color: THEME.secondary },
