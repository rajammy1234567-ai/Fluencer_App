...
const Signup = () => {
  ...
  /** Browse the app UI without signup (guest / preview mode) */
        ...
        >
          <View style={styles.header}>
            ...
            <Animated.View entering={FadeInUp.delay(200).duration(800)} style={styles.logoInfo}>
              ...
              <Text style={styles.welcomeText}>Join Fluencer</Text>
              <Text style={styles.subText}>
                {isBrand
                  ? 'Launch campaigns and partner with creators'
                  : 'Find brand deals and grow your work'}
              </Text>
              <View style={styles.roleChip}>
                <MaterialCommunityIcons
                  name={isBrand ? 'storefront-outline' : 'account-outline'}
                  size={14}
                  color={COLORS.white}
                />
          ...
          >
            <View style={styles.card}>
              ...
              <Text style={styles.skipHint}>Explore the app UI without signup</Text>
            </View>
