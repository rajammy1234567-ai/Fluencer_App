...
// Indian creators + brand logos for onboarding mosaic
const brandCards = [
  // Row 1 - 3 cards
  [
    { id: 1, type: 'logo', name: 'pinterest', bg: '#E60023', icon: 'P' },
    { id: 2, type: 'person', image: INDIAN_PEOPLE.woman1 },
    { id: 3, type: 'logo', name: 'skype', bg: '#00AFF0', icon: 'S' },
  ],
  // Row 2 - 3 cards
  [
    { id: 4, type: 'person', image: INDIAN_PEOPLE.man1 },
  ...
  [
    ...
    { id: 8, type: 'person', image: INDIAN_PEOPLE.woman2 },
    { id: 9, type: 'logo', name: 'facebook', bg: '#1877F2', icon: 'f' },
  ],
];

// Bottom row — more Indian creators
const bottomPersons = [
  { id: 10, type: 'person', image: INDIAN_PEOPLE.man2 },
  { id: 11, type: 'person', image: INDIAN_PEOPLE.woman3 },
  { id: 12, type: 'person', image: INDIAN_PEOPLE.woman4 },
  { id: 13, type: 'person', image: INDIAN_PEOPLE.man3 },
];
