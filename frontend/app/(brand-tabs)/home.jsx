...
const THEME = {
  ...
  footerTextGray: 'rgba(255,255,255,0.42)',
  gradientStart: '#7C3AED',
  gradientEnd: '#6D28FF',
  shadow: 'rgba(109, 40, 255, 0.35)',
  shadowStrong: 'rgba(168, 85, 247, 0.45)',
};

// Sample data — Indian people + Indian products only
const bannerImages = [
...
const productCategories = [
  { id: 1, name: 'Ethnic Sarees', image: INDIAN_FASHION.saree, color: '#7C3AED' },
  { id: 2, name: 'Linen Kurtas', image: INDIAN_FASHION.kurta, color: '#6D28FF' },
  { id: 3, name: 'Bridal Lehengas', image: INDIAN_FASHION.lehenga, color: '#EC4899' },
  { id: 4, name: 'Organza Dupattas', image: INDIAN_FASHION.dupatta, color: '#A855F7' },
  { id: 5, name: 'Wedding Looks', image: INDIAN_FASHION.wedding, color: '#A855F7' },
  { id: 6, name: 'Gold Jewelry', image: INDIAN_FASHION.jewelry, color: '#EC4899' },
];

const trendingProducts = [
  { id: 1, name: 'Banarasi Silk Saree', image: INDIAN_FASHION.saree },
  { id: 2, name: 'Summer Linen Kurta', image: INDIAN_FASHION.kurta },
  { id: 3, name: 'Bridal Zardozi Lehenga', image: INDIAN_FASHION.lehenga },
  { id: 4, name: '18K Gold Plated Set', image: INDIAN_FASHION.jewelry },
  { id: 5, name: 'Festive Ethnic Set', image: INDIAN_FASHION.festival },
];
...
const businessHackProducts = [
  ...
  { 
    ...
    image: INDIAN_PEOPLE.man1,
    type: 'video',
    gradient: ['#6D28FF', '#A855F7']
  },
  { 
    id: 3, 
    name: 'Overpaying Influencers', 
    image: INDIAN_PEOPLE.woman2,
    type: 'video',
...
const Navbar = ({ children, profileImage, unreadCount }) => {
  return (
    <View style={styles.navbarWrapper}>
      ...
      <LinearGradient
        colors={['#FFFFFF', 'rgba(168, 85, 247, 0.16)', 'rgba(168, 85, 247, 0.22)', '#7C3AED']}
        start={{ x: 0.5, y: 0 }}
        end={{ x: 0.5, y: 1 }}
