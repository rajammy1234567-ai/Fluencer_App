...
export default function LegalPolicy() {
  ...
  return (
    <section id="privacy" style={{ padding: 'clamp(36px, 5vw, 60px) 0', backgroundColor: '#0B0B10', color: 'rgba(255,255,255,0.8)', width: '100%' }}>
      <div className="site-container-narrow">
        ...
        {/* Highlight Card */}
        <div className="glass-card" style={{ padding: 'clamp(20px, 3.5vw, 28px)', borderRadius: '22px', borderColor: 'rgba(16, 185, 129, 0.35)', marginBottom: '28px' }}>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '16px' }}>
            <div style={{ width: '44px', height: '44px', borderRadius: '14px', background: 'rgba(16, 185, 129, 0.2)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <Lock style={{ width: '22px', height: '22px', color: '#34D399' }} />
            </div>
            <div>
              <h3 style={{ fontSize: '15px', fontWeight: '700', color: '#FFFFFF', marginBottom: '4px' }}>Key Privacy Guarantee for Brands & Influencers</h3>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div className="glass-card-static" style={{ padding: 'clamp(20px, 3vw, 28px)', borderRadius: '20px' }}>
            <h2 style={{ fontSize: '17px', fontWeight: '700', color: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
              <Building2 style={{ width: '18px', height: '18px', color: '#C084FC' }} />
              1. Overview & Scope
            </h2>
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.7)', lineHeight: '1.6', margin: 0 }}>
          ...
          <div className="glass-card-static" style={{ padding: 'clamp(20px, 3vw, 28px)', borderRadius: '20px' }}>
            <h2 style={{ fontSize: '17px', fontWeight: '700', color: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '14px' }}>
              <FileText style={{ width: '18px', height: '18px', color: '#F472B6' }} />
              2. Information We Collect
            </h2>
            <div className="grid-2" style={{ gap: '14px' }}>
              <div style={{ background: '#121218', padding: '16px', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.06)' }}>
                <h4 style={{ fontSize: '11px', fontWeight: '700', color: '#C084FC', textTransform: 'uppercase', marginBottom: '8px' }}>A. For Brands</h4>
                <ul style={{ listStyle: 'none', fontSize: '12px', color: 'rgba(255,255,255,0.7)', display: 'flex', flexDirection: 'column', gap: '5px' }}>
              ...
              <div style={{ background: '#121218', padding: '16px', borderRadius: '14px', border: '1px solid rgba(255,255,255,0.06)' }}>
                <h4 style={{ fontSize: '11px', fontWeight: '700', color: '#F472B6', textTransform: 'uppercase', marginBottom: '8px' }}>B. For Influencers</h4>
                <ul style={{ listStyle: 'none', fontSize: '12px', color: 'rgba(255,255,255,0.7)', display: 'flex', flexDirection: 'column', gap: '5px' }}>
          ...
          <div className="glass-card-static" style={{ padding: 'clamp(20px, 3vw, 28px)', borderRadius: '20px' }}>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '8px', fontSize: '13px', color: 'rgba(255,255,255,0.7)' }}>
              <li style={{ display: 'flex', gap: '8px', alignItems: 'flex-start' }}>
                <CheckCircle style={{ width: '15px', height: '15px', color: '#34D399', flexShrink: 0, marginTop: '3px' }} />
          ...
          <div className="glass-card" style={{ padding: 'clamp(20px, 3vw, 28px)', borderRadius: '20px', borderColor: 'rgba(168, 85, 247, 0.3)' }}>
            <h2 style={{ fontSize: '17px', fontWeight: '700', color: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
              <Mail style={{ width: '18px', height: '18px', color: '#EC4899' }} />
              4. Contact Privacy & App Team
            </h2>
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.7)', marginBottom: '12px', lineHeight: '1.5' }}>
              For privacy inquiries, Play Store compliance questions, or account assistance, reach out to our team directly:
            </p>
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '10px', background: '#0B0B10', padding: '10px 16px', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)', fontSize: '13px', color: '#FFFFFF' }}>
              <Mail style={{ width: '15px', height: '15px', color: '#A855F7' }} />
